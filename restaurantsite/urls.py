...
from customer.views import Index, Menu, login_view, register,profile, LogoutView, product, product_list, user_orders, add_to_cart, remove_from_cart, view_cart, view_order
